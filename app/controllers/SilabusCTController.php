...
class SilabusCTController extends BaseController {
	...
	{	
		$respuesta = SilaboCT::agregar(Input::all());

		if($respuesta['error']==true)
		{
			return Redirect::to('SilaboCarreraTxecnica/create.html')->with('mensaje',$respuesta['mensaje']);
		} 
		else 
		{
