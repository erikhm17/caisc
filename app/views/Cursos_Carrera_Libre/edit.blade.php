...
@section('title')
Actualizar<small>CURSO LIBRE </small>
@stop
...
{{ Form::open(array('method'=> 'POST','url'=> 'CursosLibres/post_update.html','class'=>'form-horizontal','role'=>'form')) }}
	<div class="form-group">
		...
		<div class="col-sm-8">
			{{ Form::text('id','',array('class'=>'form-control','placeholder'=>'','readonly' => 'readonly'))}}
		</div>
	...
	<div class="form-group">
		...
		<div class="col-sm-8">
			{{ Form::text('nombre','',array('class'=>'form-control','placeholder'=>'Ingrese nombre de Curso'))}}
		</div>
	</div>
	<div class="form-group">
		{{ Form::label('horas_academicas','Horas Academicas:',array('class'=>'col-sm-4 control-label')) }}
		<div class="col-sm-8">
			{{ Form::number('horas_academicas','',array('class'=>'form-control','placeholder'=>''))}}
		</div>
	</div>
