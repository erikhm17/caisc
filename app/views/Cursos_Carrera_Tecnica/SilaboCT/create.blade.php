...
{{ Form::open(array('method'=> 'POST','url'=> 'SilaboCarreraTecnica/insert.html','class'=>'form-horizontal','role'=>'form')) }}
	...
	<div class="form-group">
		{{ Form::label('codSilabus_ct','Carga Academica para el Silabo:',array('class'=>'col-sm-4 control-label')) }}
		<div class="col-sm-8">
			{{ Form::select('codSilabus_ct',$codSilabo,null,array('class'=>'form-control','required'))}}
		</div>
	</div>
	<div class="form-group">
